...
function App() {
  ...
  const [prompt, setPrompt] = useState('大家好,我是黄同学');
  // 状态 ready ,waiting,done 界面由数据状态驱动 
  const [status,setStatus] = useState('ready')
  // DOM 对象绑定 use 开头的都叫 hooks 函数 
  ...
  // 取调用火山接口，返回语音
  const generateAudio =() =>{
    const voiceName ="multi_female_shuangkuaisisi_moon_bigtts"; // 角色
